...
- [ ] Compile the focused test to `/private/tmp/sys-editor-draft-spec-test` with `npx tsc --skipLibCheck --target ES2022 --module NodeNext --moduleResolution NodeNext --outDir /private/tmp/sys-editor-draft-spec-test --noEmitOnError false src/vs/workbench/contrib/sys/common/test/sysFormalSpecDraft.test.ts` and run it with `node --test /private/tmp/sys-editor-draft-spec-test/test/sysFormalSpecDraft.test.js`; confirm the new tests fail before implementation.
...
- [ ] Run focused draft helper and preview decoder tests with `npx tsc --skipLibCheck --target ES2022 --module NodeNext --moduleResolution NodeNext --outDir /private/tmp/sys-editor-draft-spec-test --noEmitOnError false src/vs/workbench/contrib/sys/common/test/sysFormalSpecDraft.test.ts src/vs/workbench/contrib/sys/common/test/sysPlatformFlow.test.ts`, then `node --test /private/tmp/sys-editor-draft-spec-test/test/sysFormalSpecDraft.test.js /private/tmp/sys-editor-draft-spec-test/test/sysPlatformFlow.test.js`; run `npm run lint` from `/Volumes/Work/dev/sys-editor`.
